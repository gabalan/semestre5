...
Env * init(SDL_Window* win, SDL_Renderer* ren, int argc, char* argv[])
{
  ...
  SDL_Surface * surf = TTF_RenderText_Blended(font, "salut", color); // blended rendering for ultra nice text
...
bool process(SDL_Window* win, SDL_Renderer* ren, Env * env, SDL_Event * e)
{
  ...
  /* other events */
    ...
    case SDLK_LEFT:  env->bomb_x -= 200; break;
